...
export default function NewProjectPage() {
  ...
  const onSubmit = async (data: ProjectFormData) => {
    // Note: implementation of POST route /api/projects is needed.
    // Assuming it's implemented or we'll mock it here.
    try {
      // Mock save
    ...
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      <header className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-text-secondary mt-1">Create a new portfolio item.</p>
        </div>
      </header>
